...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("FileManage", cocos2d::Rect(0, 0, mediumResolutionSize.width, mediumResolutionSize.height));
#else
	...
	ViewLayer *viewlayer = ViewLayer::create();
